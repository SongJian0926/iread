...
@Controller
@RequestMapping("/cms/animalDescribe")
public class AnimalDescribeController  extends BaseController
{
	@Autowired
	private AnimalDescribeService animalDescribeService;
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="findDescribeNEStatusPage",method=RequestMethod.POST)
	public XaResult<Page<AnimalDescribe>> findBookNEStatusPage(
		...
		return animalDescribeService.findListNEStatusByFilter(status, filterParams, pageable);	
	}
}
