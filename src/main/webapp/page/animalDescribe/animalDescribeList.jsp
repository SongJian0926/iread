...
<html>
  <head>
	...
	<script type="text/javascript">
			var editUrl = 'animalDescribeEdit.jsp?id=';//增加，修改的时候需要跳转的页面
			//var operateUrl = root + 'cms/animalDescribe/operateDescribeByIds';//删除的时候需要请求的action的一部分
			var contentUrl = root + "cms/animalDescribe/findDescribeNEStatusPage";
